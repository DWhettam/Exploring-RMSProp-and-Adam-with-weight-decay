...
class Optimiser(object):
    ...
    def __init__(self, model, error, learning_rule, scheduler, train_dataset, valid_dataset=None, data_monitors=None, notebook=False):
    ...
    def train(self, num_epochs, stats_interval=5):
        ...
        with self.tqdm_progress(total=num_epochs) as progress_bar:
            ...
            for epoch in range(1, num_epochs + 1):
                ...
                self.learning_rule.learning_rate = self.scheduler.update_learning_rule(self.learning_rule, epoch)                
